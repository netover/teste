...
class AlertRule(Base):
    ...
    job_name_pattern = Column(String, nullable=False, default="*") # Glob pattern, e.g., "PAYROLL_*"
    status_trigger = Column(SAEnum(JobStatusEnum), nullable=False)
    severity = Column(SAEnum(AlertSeverityEnum), nullable=False, default=AlertSeverityEnum.HIGH)
