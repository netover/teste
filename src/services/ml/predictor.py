...
from src.services.ml.models import JobFailurePrediction, RiskFactor, AnomalyDetectionResult, TrainingMetrics
...
class JobFailurePredictorML:
    ...
    def _identify_risk_factors(self, features: list, importance: dict) -> List[RiskFactor]:
